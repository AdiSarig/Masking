...
vpix_trig=uint8([bg+2 bg-2 bg+2 bg-2 bg+2 bg-2 bg+2 bg-2,...
    ...
    bg+3 bg-4 bg+3 bg-4 bg+3 bg-4 bg+3 bg-4;...
...
session.stim.triggers.inter = vpix_trig(:,25:32);     % intermission trigger
session.stim.triggers.end = vpix_trig(:,33:40);       % intermission trigger
